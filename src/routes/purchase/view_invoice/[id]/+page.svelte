    ...
    <div class="invoice printable">
        ...
        <div class="company flex-sb">
            ...
            <div class="invoice-info" style="margin-right: 24px;">
                ...
                <span>Purchase Inv. # : P.Inv-{data.invoice.invoice.doc_number}</span>
            </div>
        </div>
        <hr>
        <div class="vendor flex-sb">
            <div class="vendor-info">
                ...
                <span>{data.invoice.vendor.name}</span>
                <span>{data.invoice.vendor.street_address}</span>
                <span>{data.invoice.vendor.city}, {data.invoice.vendor.state}</span>
                <span>PIN - {data.invoice.vendor.postal_code}</span>
                <span>{data.invoice.vendor.phone}</span>
                <span>{data.invoice.vendor.email}</span>
            </div>
            <div class="ship-info">
...
<style>
    ...
    .invoice .vendor .vendor-info,
    .invoice .vendor .ship-info {
        display: grid;
        gap: .1rem;
    }
