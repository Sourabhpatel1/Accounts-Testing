    ...
    <div class="order printable">
        ...
        <div class="company flex-sb">
            ...
            <div class="order-info" style="margin-right: 24px;">
                ...
                <span>SO # : SO-{data.order.order.doc_number}</span>
            </div>
        </div>
        <hr>
        <div class="customer flex-sb">
            <div class="customer-info">
                ...
                <span>{data.order.customer.street_address}</span>
                <span>{data.order.customer.city}, {data.order.customer.state}</span>
                <span>PIN - {data.order.customer.postal_code}</span>
                <span>{data.order.customer.phone}</span>
                <span>{data.order.customer.email}</span>
            </div>
            <div class="ship-info">
                <span style="font-weight: 700;">Ship To:</span>
                <span>{data.order.customer.name}</span>
                <span>{data.order.customer.street_address}</span>
                <span>{data.order.customer.city}, {data.order.customer.state}</span>
                <span>PIN - {data.order.customer.postal_code}</span>
