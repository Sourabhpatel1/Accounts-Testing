<script>
    ...
    const filter = () => {
        ...
        if (customer_id) {
            orders = orders.filter(o=>o.order.customer_id===customer_id)
        }
        if (orderNum) {
...
<section class="flex flex-col">
    ...
    <div class="filters">
        ...
        <div class="group single">
            <label for="vendor">Filter by Customer</label>
            <Select
            class='select'
            id='vendor'
            items={customers}
    ...
    <div class="orders">
        ...
        <div class="row">
            <span>{i+1}</span>
            <span>SO-{order.order.doc_number}</span>
            ...
            <div class="actions">
                <a href="/sales/view_so/{order.order.id}">
