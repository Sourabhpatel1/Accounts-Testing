...
<section class="flex flex-col">
    ...
    <div class="invoices">
        ...
        <div class="row">
            <span>{i+1}</span>
            <span>S.Inv-{invoice.invoice.doc_number}</span>
            <span>{invoice.invoice.doc_date}</span>
            <span>{invoice.customer.name}</span>
            <span>{invoice.invoice.state_type===1?'Intra':'Inter'}</span>
            <span>{invoice.order_number?"SO-"+invoice.order_number.doc_number:""}</span>
            ...
            <div class="actions">
                <a href="/sales/view_invoice/{invoice.invoice.id}">
